  ...
  const handleImport = async () => {
    ...
    for (let r = 0; r < rows.length; r++) {
      ...
      const leadRecord: LeadInsert = {
        ...
        fm_type: getFmType(getVal('fm_type')),
        source: getVal('source') || 'Facebook_Ads',
        lead_quality: getLeadQuality(getVal('lead_quality')),
        follow_up_status: getFollowUpStatus(getVal('follow_up_status')),
        objection_tag: undefined,
        last_remark: getVal('last_remark') || null,
